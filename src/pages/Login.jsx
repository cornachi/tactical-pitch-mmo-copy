...
export const Login = () => {
  ...
  const handleGoogleLogin = () => {
    // Abre a página principal do backend Base44 em nova aba para concluir autenticação OAuth
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md space-y-6 bg-white p-8 rounded-xl shadow-md border border-slate-100">
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full py-5 flex items-center justify-center gap-2 text-slate-700 font-medium"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <Link to="/forgot-password" className="text-xs text-lime-600 hover:underline font-medium">
                Forgot password?
              </Link>
            </div>
            <Input
