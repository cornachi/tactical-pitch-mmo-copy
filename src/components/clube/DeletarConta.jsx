  ...
  return (
    <Card className="p-4 border-rose-200">
      ...
      <p className="text-sm text-muted-foreground mt-1">
        Exclui permanentemente seu clube, atributos, troféus, notificações e histórico de partidas. Esta ação é irreversível.
      </p>
      <AlertDialog open={open} onOpenChange={(o) => { setOpen(o); if (!o) setConfirmText(""); }}>
        <AlertDialogTrigger asChild>
          <Button variant="destructive" className="mt-3 w-full">Deletar Conta</Button>
        </AlertDialogTrigger>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Tem certeza absoluta?</AlertDialogTitle>
            <AlertDialogDescription>
              Todos os dados do seu clube serão permanentemente apagados e você será desconectado. Digite <b>DELETAR</b> para confirmar.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <Input
            value={confirmText}
          ...
          <AlertDialogFooter>
            ...
            >
              {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : "Deletar Permanentemente"}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
